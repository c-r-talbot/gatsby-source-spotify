...
commander_1["default"]
    ...
    .action(function (clientId, clientSecret) {
    ...
    http_1["default"]
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, spotify_api_1.getTokens(clientId, clientSecret, code, 'authorization_code')];
                case 1:
                    tokens = _a.sent();
        ...
        .listen(5071);
    var authUrl = spotify_api_1.generateAuthUrl(clientId);
