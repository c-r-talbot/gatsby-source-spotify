        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    _b = gatsby_source_filesystem_1.createFileNodeFromBuffer;
                    _c = {};
                    return [4 /*yield*/, testRes.buffer()];
                case 3: return [4 /*yield*/, _b.apply(void 0, [(_c.buffer = _d.sent(),
                            _c.store = store,
                            _c.cache = cache,
                            _c.createNode = createNode,
                            _c.createNodeId = createNodeId,
                            _c.name = id.replace(/[^a-z0-9]+/gi, '-'),
                            _c.ext = '.jpg',
                            _c)])];
                case 4:
                    fileNode = _d.sent();
...
exports.sourceNodes = function (_a, pluginOptions) {
    ...
    return __awaiter(_this, void 0, void 0, function () {
        var createNode, touchNode, helpers, _b, tracks, artists, playlists, recentTracks, savedAlbums;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _b = _c.sent(), tracks = _b.tracks, artists = _b.artists, playlists = _b.playlists, recentTracks = _b.recentTracks, savedAlbums = _b.savedAlbums;
                    return [4 /*yield*/, Promise.all(tracks.map(function (track, index) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, referenceRemoteFile(track.album.uri, track.album.images[0].url, helpers)];
                                    case 1:
                                        _e = _f.sent();
                                        return [3 /*break*/, 3];
                                    case 2:
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, referenceRemoteFile(artist.uri, artist.images[0].url, helpers)];
                                    case 1:
                                        _e = _f.sent();
                                        return [3 /*break*/, 3];
                                    case 2:
                            ...
                            return __generator(this, function (_f) {
                                switch (_f.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, referenceRemoteFile(playlist.uri, playlist.images[0].url, helpers)];
                                    case 1:
                                        _e = _f.sent();
                                        return [3 /*break*/, 3];
                                    case 2:
                        ...
                        }); }), savedAlbums.map(function (album, index) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                createNode(nodes_1.SavedAlbumNode(__assign({}, album, { id: index, order: index })));
                                return [2 /*return*/];
                            });
                            ...
                            return __generator(this, function (_h) {
                                switch (_h.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, referenceRemoteFile(track.track.uri, track.track.album.images[0].url, helpers)];
                                    case 1:
                                        _g = _h.sent();
                                        return [3 /*break*/, 3];
                                    case 2:
