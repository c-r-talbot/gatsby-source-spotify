...
exports.generateAuthUrl = function (clientId, scopes) {
    if (scopes === void 0) { scopes = ['user-top-read', 'user-read-recently-played', "user-read-private", "user-library-read"]; }
...
exports.getSavedAlbums = function (accessToken, limit, next) {
    if (limit === void 0) { limit = 50; }
    if (next === void 0) { next = exports.SPOTIFY_API_URL + "/me/albums?limit=50"; }
    return __awaiter(_this, void 0, void 0, function () {
        var url, response, _a, _b, result;
        return __generator(this, function (_c) {
            switch (_c.label) {
...
exports.getUserData = function (_a) {
    var clientId = _a.clientId, clientSecret = _a.clientSecret, refreshToken = _a.refreshToken, _b = _a.timeRanges, timeRanges = _b === void 0 ? ['short_term', 'medium_term', 'long_term'] : _b, _c = _a.fetchPlaylists, fetchPlaylists = _c === void 0 ? true : _c, _d = _a.fetchRecent, fetchRecent = _d === void 0 ? true : _d;
    return __awaiter(_this, void 0, void 0, function () {
        var access_token, playlists, _e, recentTracks, _f, savedAlbums, albums, next, artists, tracks;
        var _this = this;
        return __generator(this, function (_g) {
            switch (_g.label) {
                case 0: return [4 /*yield*/, exports.getTokens(clientId, clientSecret, refreshToken, 'refresh_token')];
                case 1:
                    access_token = (_g.sent()).access_token;
                ...
                case 4:
                    playlists = _e;
                    if (!fetchRecent) return [3 /*break*/, 6];
                ...
                case 7:
                    recentTracks = _f;
                    savedAlbums = [];
                    return [4 /*yield*/, exports.getSavedAlbums(access_token)];
                case 8:
                    albums = _g.sent();
                    savedAlbums = savedAlbums.concat.apply(savedAlbums, albums.items);
                    _g.label = 9;
                case 9:
                    if (!!(albums.next == null)) return [3 /*break*/, 11];
                    next = albums.next;
                    console.log(next);
                    return [4 /*yield*/, exports.getSavedAlbums(access_token, undefined, next)];
                case 10:
                    albums = _g.sent();
                    savedAlbums = savedAlbums.concat.apply(savedAlbums, albums.items);
                    return [3 /*break*/, 9];
                case 11: return [4 /*yield*/, Promise.all(timeRanges.map(function (t) { return __awaiter(_this, void 0, void 0, function () {
                        var artists;
